...
public class Creature {
  ...
  public Creature(int generation, World world) {
    ...
    this.getPatientCompare().getConfiguration().setGeneration(generation);
    this.getPatientCompare().getConfiguration().setGeneratedDate(new Date());
    Configuration configuration = patientCompare.getConfiguration();
    configuration.setWorldName(world.getWorldName());
    configuration.setIslandName(world.getIslandName());
    scorer = new Scorer();
  }
   ...
   */
  public Creature(World world, String configurationString) {
    this.world = world;
    patientCompare = new PatientCompare(configurationString);
    Configuration configuration = patientCompare.getConfiguration();
    configuration.setWorldName(world.getWorldName());
    configuration.setIslandName(world.getIslandName());
    this.generation = patientCompare.getConfiguration().getGeneration();
    scorer = new Scorer();
  }
  ...
  {
    patientCompare = new PatientCompare(connectionString);
    this.generation = patientCompare.getConfiguration().getGeneration();
  }
  ...
  public String toString() {
    patientCompare.getConfiguration().createConfigurationScript(); // Make sure we have the latest script before sending
    return patientCompare.getConfiguration().getConfigurationScript();
  }
  ...
  public Creature(int generation, Creature parentA, Creature parentB) {
    ...
    patientCompare = new PatientCompare(parentA.getPatientCompare().getConfiguration().getConfigurationScript());
    this.getPatientCompare().getConfiguration().setGeneration(generation);
    this.getPatientCompare().getConfiguration().setGeneratedDate(new Date());
  ...
  public Creature(int generation, Creature clone) {
    ...
    patientCompare = new PatientCompare(clone.getPatientCompare().getConfiguration().getConfigurationScript());
    this.getPatientCompare().getConfiguration().setGeneration(generation);
    this.getPatientCompare().getConfiguration().setGeneratedDate(new Date());
  ...
  public void score() {
    ...
    patientCompare.getConfiguration().setGenerationScore(score);
    scored = true;
  }
